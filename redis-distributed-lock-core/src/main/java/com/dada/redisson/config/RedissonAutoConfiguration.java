package com.dada.redisson.config;

import com.dada.redisson.RedissonLock;
import com.dada.redisson.RedissonManager;
...
//@ComponentScan("com.dada.redisson.annotation")
